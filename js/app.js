...
//crear arreglo para carrito
let carrito = JSON.parse(localStorage.getItem("carrito")) || []

//variable que suma los precios del carrito
let sumaCarrito=0

//contador del bagde de carrito
...
//body del modal
let cuerpoModal=documen.querySelector(".modal-body")
...
//let prod3 = new Producto(3,"Teclado Mecanico",4800,2,"https://d2r9epyceweg5n.cloudfront.net/stores/911/585/products/philips-teclado-g605-11-48b5b57b29daafb8a116019913576074-1024-1024.jpg")
...
function cargarCard(){
    ...
    for (let i = 0; i < productos.length; i++) {
        ...
        div.innerHTML = ` 
        <div class="card-deck" id="contenedor">
        <div class="card">
...
function agregarCarrito(codigo){
    ...
    if(productos[indexProd].stock>=1){
       ...
       //-------------------------------------------------
       //verificar que el producto no este ya en el carrito
       //-------------------------------------------------
...
carrito.forEach(function(prod) {
    ...
    <div class="col-md-4">
      <img class ="imagenCarrito" img src="${[prod.imagen]}" alt="${[prod.nombre]}">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">${[prod.cantidad]} ${[prod.nombre]}
        <p class="card-text">Precio: $${[prod.precio]}</p>
        <a href="#" clas="btn btn-danger">Eliminar</a>
      </div>
    </div>
  </div>
  `
